...
RpcClient.callspec = {
  // normal comments are rpc not working with zcoin, 
  // new rpc cmds are copied from debug window.
  // BIG DIFFERENCE is no CamelCase style RPC commands.
  //
  // abandontTransaction: 'str',
  addmultisigaddress: '',
  addnode: '',
  backupwallet: '',
  createmultisig: '',
